    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <header className="bg-[#6d0f16] text-white px-8 py-4 shadow-md flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* OUTPASS SETTINGS BUTTON */}
          <button
            onClick={() => setIsOutpassSettingsModalOpen(true)}
            className="bg-slate-700 hover:bg-slate-800 text-white px-4 py-2 rounded-xl text-xs font-semibold transition shadow-xs flex items-center gap-1.5 cursor-pointer"
          >
            <span>⚙️</span>
