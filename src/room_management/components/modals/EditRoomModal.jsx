...
export default function EditRoomModal({ isOpen, onClose, room, hostelName, onUpdate, onDelete, onAssignResident, onRemoveResident }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
      <div className="bg-white rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.15)] border border-gray-100 w-full max-w-md overflow-hidden pointer-events-auto flex flex-col max-h-[90vh]">

        <div className="bg-[#6d0f16] text-white px-6 py-4 flex justify-between items-center shrink-0">
        ...
        <div className="overflow-y-auto">
          ...
          {onAssignResident && onRemoveResident && (
